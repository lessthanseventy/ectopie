defmodule EctoprintWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EctoprintWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EctoprintWeb.Gettext, "errors", msg, opts)
    end
  end
